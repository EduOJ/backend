...
func Register(e *echo.Echo) {
	...
	admin.PUT("/problem/:id",
		controller.UpdateProblem, middleware.HasPermission(middleware.ScopedPermission{P: "update_problem", T: "problem"})).Name = "problem.updateProblem"
	admin.DELETE("/problem/:id",
		controller.DeleteProblem, middleware.HasPermission(middleware.ScopedPermission{P: "delete_problem", T: "problem"})).Name = "problem.deleteProblem"
	...
	admin.POST("/problem/:id/test_case",
		...
		middleware.HasPermission(middleware.ScopedPermission{P: "update_problem", T: "problem"})).Name = "problem.createTestCase"
	admin.PUT("/problem/:id/test_case/:test_case_id",
		controller.UpdateTestCase,
		middleware.HasPermission(middleware.ScopedPermission{P: "update_problem", T: "problem"})).Name = "problem.updateTestCase"
	admin.DELETE("/problem/:id/test_case/all",
		controller.DeleteTestCases,
		middleware.HasPermission(middleware.ScopedPermission{P: "update_problem", T: "problem"})).Name = "problem.deleteTestCases"
	admin.DELETE("/problem/:id/test_case/:test_case_id",
		controller.DeleteTestCase,
		middleware.HasPermission(middleware.ScopedPermission{P: "update_problem", T: "problem"})).Name = "problem.deleteTestCase"

	admin.GET("/problem/:id/test_case/:test_case_id/input_file",
		controller.GetTestCaseInputFile,
		middleware.HasPermission(middleware.ScopedPermission{P: "read_problem_secret", T: "problem"})).Name = "problem.getTestCaseInputFile"
	admin.GET("/problem/:id/test_case/:test_case_id/output_file",
		controller.GetTestCaseOutputFile,
		middleware.HasPermission(middleware.ScopedPermission{P: "read_problem_secret", T: "problem"})).Name = "problem.getTestCaseOutputFile"
